...
<context>
    <name>ACsvAdd</name>
    <message>
        <location filename="csv/acsvadd.cpp" line="40"/>
        <source>(TR) Can&apos;t get the csv line data</source>
        <oldsource>Can&apos;t get the csv line data</oldsource>
        <translation>Can&apos;t get the csv line data</translation>
    </message>
    <message>
        <location filename="csv/acsvadd.cpp" line="48"/>
        <source>(TR) A problem occured while trying to append an element to the CSV line.</source>
        <oldsource>A problem occured while trying to append an element to the CSV line.</oldsource>
        <translation>A problem occured while trying to append an element to the CSV line.</translation>
    </message>
    <message>
        <location filename="csv/acsvadd.cpp" line="60"/>
        <source>(TR) A problem occured while trying to output the CSV line.</source>
        <oldsource>A problem occured while trying to output the CSV line.</oldsource>
        <translation>A problem occured while trying to output the CSV line.</translation>
    </message>
</context>
<context>
    <name>CsvLogLine</name>
    <message>
        <location filename="csv/csvlogline.cpp" line="38"/>
        <source>(TR) A problem occured when tryied to log the CSV line.</source>
        <oldsource>A problem occured when tryied to log the CSV line.</oldsource>
        <translation>A problem occured when tryied to log the CSV line.</translation>
    </message>
</context>
<context>
