...
/** @brief Test if the value got from event is greater than the one given "to compare with" */
class GreaterThanDecisionalTransition : public ADecisionalTransition
{
    Q_OBJECT
    ...
    public:
        ...
        explicit GreaterThanDecisionalTransition(bool testEquality,
    ...
    public:
        ...
        /** @brief Test if the value are greater than the "value to compare with"
