...
<context>
    <name>FromRefBoolAssignmentOperator</name>
    <message>
        <location filename="operations/fromrefboolassignmentoperator.cpp" line="72"/>
        <source>(TR) One select value has to be chosen (only one)</source>
        <oldsource>One select value has to be chosen (only one)</oldsource>
        <translation>One select value has to be chosen (only one)</translation>
    </message>
    <message>
        <location filename="operations/fromrefboolassignmentoperator.cpp" line="90"/>
        <source>(TR) A select value has to be chosen, unknown key: %1</source>
        <oldsource>A select value has to be chosen, unknown key: %1</oldsource>
        <translation>A select value has to be chosen, unknown key: %1</translation>
    </message>
</context>
<context>
    <name>FromRefNumberArithmeticOperator</name>
    <message>
        <location filename="operations/fromrefnumberarithmeticoperator.cpp" line="99"/>
        <source>(TR) The number value given is unknown, key linked: %1</source>
        <oldsource>The number value given is unknown, key linked: %1</oldsource>
        <translation>The number value given is unknown, key linked: %1</translation>
    </message>
    <message>
        <location filename="operations/fromrefnumberarithmeticoperator.cpp" line="130"/>
        <source>(TR) One select value has to be chosen (only one)</source>
        <oldsource>One select value has to be chosen (only one)</oldsource>
        <translation>One select value has to be chosen (only one)</translation>
    </message>
    <message>
        <location filename="operations/fromrefnumberarithmeticoperator.cpp" line="156"/>
        <source>(TR) A select value has to be chosen, unknown key: %1</source>
        <oldsource>A select value has to be chosen, unknown key: %1</oldsource>
        <translation>A select value has to be chosen, unknown key: %1</translation>
    </message>
...
<context>
    <name>FromRefNumberAssignmentOperator</name>
    <message>
        <location filename="operations/fromrefnumberassignmentoperator.cpp" line="103"/>
        <source>(TR) One select value has to be chosen (only one)</source>
        <oldsource>One select value has to be chosen (only one)</oldsource>
        <translation>One select value has to be chosen (only one)</translation>
    </message>
    <message>
        <location filename="operations/fromrefnumberassignmentoperator.cpp" line="125"/>
        <source>(TR) A select value has to be chosen, unknown key: %1</source>
        <oldsource>A select value has to be chosen, unknown key: %1</oldsource>
        <translation>A select value has to be chosen, unknown key: %1</translation>
    </message>
