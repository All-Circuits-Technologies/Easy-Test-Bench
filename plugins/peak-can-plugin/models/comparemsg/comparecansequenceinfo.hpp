...
class CompareCanSequenceInfo : public QObject
{
    Q_OBJECT
    ...
    private:
        ...
        explicit CompareCanSequenceInfo(
    ...
    public:
        ...
        virtual ~CompareCanSequenceInfo() override;

    public:
        /** @brief Get the list of the commands to send */
        const QVector<const CompareCanSequenceActionInfo*> &getSeqActionsInfo() const
    ...
    public:
        /** @brief Parse the PEAK CAN sequence information from the parameters given
            ...
            @return The created @ref PCanWritingInfo thanks to the given parameters or nullptr if
                    a problem occurred. */
        static const CompareCanSequenceInfo *parsePCanSequenceInfo(
            const CanMsgSeqParams &msgSeqParams,
            bool manageMultipleCmd = false);

    private:
        QVector<const CompareCanSequenceActionInfo*> _seqActionsInfo;
