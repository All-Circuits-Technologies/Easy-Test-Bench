...
<context>
    <name>AMeasureBoundsTest</name>
    <message>
        <location filename="comparators/ameasureboundstest.cpp" line="34"/>
        <source>(TR) A problem occured while trying to test the measure got</source>
        <oldsource>A problem occured while trying to test the measure got</oldsource>
        <translation>A problem occured while trying to test the measure got</translation>
    </message>
    <message>
        <location filename="comparators/ameasureboundstest.cpp" line="43"/>
        <source>(TR) The measure given isn&apos;t in the expected boundaries</source>
        <oldsource>The measure given isn&apos;t in the expected boundaries</oldsource>
        <translation>The measure given isn&apos;t in the expected boundaries</translation>
    </message>
    <message>
        <location filename="comparators/ameasureboundstest.cpp" line="65"/>
        <source>(TR) A problem occured when tryied to set the test result on output</source>
        <oldsource>A problem occured when tryied to set the test result on output</oldsource>
        <translation>A problem occured when tryied to set the test result on output</translation>
    </message>
</context>
<context>
