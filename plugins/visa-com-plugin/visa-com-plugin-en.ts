...
<context>
    <name>AVisaSetup</name>
    <message>
        <location filename="setup/avisasetup.cpp" line="48"/>
        <source>(TR) A problem occured while trying to setup a visa interface for communication</source>
        <oldsource>A problem occured while trying to setup a visa interface for communication</oldsource>
        <translation>A problem occured while trying to setup a visa interface for communication</translation>
    </message>
    <message>
        <location filename="setup/avisasetup.cpp" line="59"/>
        <source>(TR) A problem occured while trying to set the interface id in output</source>
        <oldsource>A problem occured while trying to set the interface id in output</oldsource>
        <translation>A problem occured while trying to set the interface id in output</translation>
    </message>
</context>
<context>
